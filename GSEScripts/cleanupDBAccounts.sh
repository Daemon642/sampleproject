...
PASSWORD=$1
#
./runManageOPC_DBCS.sh gse_support-admin@oracleads.com ${PASSWORD} usoracle05758 z11 CleanupAccount
...
./runManageOPC_DBCS.sh gse_support-admin@oracleads.com ${PASSWORD} usoracle07819 z11 CleanupAccount
