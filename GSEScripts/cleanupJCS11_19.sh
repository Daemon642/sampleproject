...
if [ $# -lt 1 ]
then
        echo "Usage: cleanupJCS11_19.sh <password>" 
        exit 1
fi
#
PASSWORD=$1
...
./runManageOPC_JCS.sh gse_support-admin@oracleads.com ${PASSWORD} usoracle03294 z11 CleanupAccount
...
./runManageOPC_JCS.sh gse_support-admin@oracleads.com ${PASSWORD} usoracle32870 z11 CleanupAccount
